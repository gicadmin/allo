                     ...
                     decode(deq_time, NULL, 
                       ...
                       decode (expiration , NULL , 'MAX_RETRY_EXCEEDED',
                            'TIME_EXPIRATION'),
                             ...
                             EXPIRATION_REASON , sender_name SENDER_NAME, sender_address SENDER_ADDRESS, sender_protocol SENDER_PROTOCOL, dequeue_msgid ORIGINAL_MSGID  FROM "INH_QTAB" WHERE state != 7 AND   state != 9 WITH READ ONLY;